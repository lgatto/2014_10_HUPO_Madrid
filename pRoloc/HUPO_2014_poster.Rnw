    ...
    \begin{column}{.48\textwidth}
      \challenge{
        \begin{block}{Introduction}     
          \vspace{3mm}
          \begin{large}
            Organelle proteomics, or spatial proteomics, is the
            systematic study of proteins and their assignment to
            subcellular niches including organelles.
            ...
            from any type of experiment such as LOPIT, PCP or
            PCP-SILAC.
            \end{large}
     ...
     % \vspace{2cm}
      ...
      \begin{block}{2) Quality control}
        ...
        We verify on PCA plots that there is structure in the data
