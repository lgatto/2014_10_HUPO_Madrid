...
\institute[CCP]{
  \begin{small}
    ...
    $^4$Chr. Hansen A/S, H\o rsholm, Denmark / Technical University of Denmark, Kgs. Lyngby, Denmark\\
  ...
  \begin{columns}
    ...
    \begin{column}{.48\textwidth}
     \begin{block}{Introduction}
       \justifying \secintro{ The \R statistical environment and
         ...
         on genomics, R/Bioconductor are gaining increasing attention
         in the proteomics, metabolomics and mass spectrometry
    ...
    \begin{column}{.48\textwidth}
      ...
      \begin{block}{Conclusion}
        \secintro{A wide range of other applications such as
          post-translational modifications (\Rpackage{isobar}) or
          spatial proteomics (\Rpackage{pRoloc}) are available as
          Bioconductor packages. A complete list is available on the
          Bioconductor page and in the \Rpackage{RforProteomics}
          package.  }
      \end{block}
